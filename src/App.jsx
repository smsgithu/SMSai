...
import { Wallet, Sparkles, Send, Home, User, LogOut, Loader2, Twitter, Youtube, Video, Instagram, Linkedin, Calendar, ChevronDown } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex flex-col">
      ...
      {/* Header with centered tickers */}
      <div className="bg-black/60 backdrop-blur-md border-b border-purple-500/20 px-4 py-3">
        <div className="max-w-6xl mx-auto">
          {/* Price Tickers - Centered */}
          <div className="flex justify-center items-center gap-6 mb-2">
            ...
            {smsPrice && (
              <div className="flex items-center gap-2">
                <a href="https://jup.ag/tokens/A9FmiDpt5UMwuvJgR759RJMEHdXzwwymyisMNfxvBAGS" target="_blank" rel="noopener noreferrer" className="text-pink-400 font-semibold text-xs sm:text-sm hover:text-pink-300 transition-colors">$SMS</a>
                ...
                <a href="https://jup.ag/tokens/A9FmiDpt5UMwuvJgR759RJMEHdXzwwymyisMNfxvBAGS" target="_blank" rel="noopener noreferrer" className="ml-1 bg-gradient-to-r from-pink-600 to-purple-600 text-white text-[10px] px-2 py-0.5 rounded-full font-semibold hover:from-pink-500 hover:to-purple-500 transition-all">Buy</a>
              </div>
            )}
          </div>
          ...
          <div className="flex justify-center">
            <div className="bg-gradient-to-r from-green-600/20 to-emerald-600/20 border border-green-500/30 rounded-full px-4 py-1.5">
              <p className="text-xs sm:text-sm text-green-300 text-center">
                ✨ <span className="font-semibold">100% Free to use</span> • Start with 5 questions • Connect a wallet for unlimited access & XP rewards
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center px-4 pt-6 pb-4 overflow-y-auto">
        <div className="w-full max-w-4xl">
          ...
          <div className="space-y-4 mb-24 max-w-2xl mx-auto">
